...
public class IntervalTraining extends Application {
    ...
    public void start(Stage stage) {
        ...
        configRoot.getChildren().addAll(configTitle, intervalOptions, initializeModuleButton);
    ...
    public void processModuleInitialization(ActionEvent event) {
        ...
        Text questionText = new Text("Identify the interval played.");
